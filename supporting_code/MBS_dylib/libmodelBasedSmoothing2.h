...
extern LIB_libmodelBasedSmoothing2_CPP_API void MW_CALL_CONV modelBasedSmoothing_wARGS(int nargout, mwArray& smoothProbMap, const mwArray& probMap, const mwArray& numCentroidsUsed, const mwArray& numFits);
