function [p_init, q_init, q_init2, Offsets1, Offsets2] = initializeModelSegmentsAAM_2inits_perSomite(centroids, modelCentroids, modelParams, modelSegmentsAAM, numOffsets, offsetScale)
...
%
p_model = modelParams.p_model;
q_model = modelParams.q_model;

% initialize
p_init  = zeros(size(p_model));
q_init  = zeros(size(q_model));
q_init2 = zeros(size(q_model));
