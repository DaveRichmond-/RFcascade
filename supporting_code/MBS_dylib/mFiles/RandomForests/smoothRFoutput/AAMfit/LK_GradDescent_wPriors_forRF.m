function [q_final,p_final, sp_final, q, p, sp_save, Err_image_vec, conv_flag] = LK_GradDescent_wPriors_forRF(raw_image,A0_vec,s0,s0_vec,Sj,Sj_vec,Sja,Sja_vec,weights,SFP_positions,pixelList,H,SD,q_init,p_init,thresh,num_iters,reg_weights,step_size)
