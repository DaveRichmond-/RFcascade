function [q_final,p_final, L_final, sp_final, q, p, L, sp_save, conv_flag] = LK_GradDescent_Sim_wPriors(raw_image,A0_vec,Grad_A0_vec,Ai_vec,Grad_Ai_vec,dNdq,dWdp,...
    s0,s0_vec,Sj,Sj_vec,Sja,Sja_vec,weights,SFP_positions,pixelList,q_init,p_init,L_init,thresh,num_iters,reg_weights,step_size)
