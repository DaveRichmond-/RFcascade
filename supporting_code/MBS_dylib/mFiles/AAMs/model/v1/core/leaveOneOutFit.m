function [shape, appear] = leaveOneOutFit(imageStack, dataSet, SFPpoints);
...
for i = 1:length(som_nums),
    ...
    clear R Psi Lambda PsiT x_vector b err
    
    % [3] appearance --------------------------->

    % build model
    
    [gbar, R, Psi, Lambda, PsiT, X, Y, CC] = make_appearance_model(imageStack, model_data, xbar_vector, SFPpoints);
    ...
    clear xbar_vector gbar R Psi Lambda PsiT X Y CC g b err
